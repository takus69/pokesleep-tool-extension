...
既存の [Pokémon Sleep Tool](https://nitoyon.github.io/pokesleep-tool/) に、ランキングなどの任意機能を追加するChrome／Edge向けManifest V3拡張です。現在は基盤構築段階で、互換性を確認して安全に起動する疎通機能のみを実装しています。公開中のfork版を置き換えるものではありません。
...
- 外部コード: 実行時にダウンロードしない
- 未実装: ランキング本体、Safari、Androidブックマークレット、ストア公開
